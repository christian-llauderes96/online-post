            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        ...
                        <div class="nav-item theme-text">
                            <a href="{{ route("posts") }}" class="nav-link"> CJ PROJECT </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu {{ Request::routeIs('posts') ? 'active' : '' }}">
                        <a href="{{ route("posts") }}" aria-expanded="{{ Request::routeIs('posts') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::routeIs('chats') ? 'active' : '' }}">
                        <a href="{{ route("chats") }}" aria-expanded="{{ Request::routeIs('chats') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
