                            ...
                            <div class="row">
                                ...
                                <form action="{{ route("validate.login") }}" method="POST">
                                    ...
                                    @if(session()->has('success'))
                                        <div class="col-12">
                                            <div class="alert alert-success text-center"><span class="text-success">{{ session('success') }}</span></div>
                                        </div>
                                    @endif
                                    @if ($errors->has('loginerror'))
                                        <div class="col-12">
                                            <div class="alert alert-danger text-center"><span class="text-danger">{{ $errors->first('loginerror') }}</span></div>
                                        </div>
                                    @endif
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Email</label>
                                            <input type="email" name="email" class="form-control" @if (isset($_COOKIE['email']))
                                                value="{{ $_COOKIE['email'] }}"
                                            @endif>
                                            @error('username')
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="password" name="password" class="form-control" @if (isset($_COOKIE['password']))
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <div class="form-check form-check-primary form-check-inline">
                                                <input class="form-check-input me-3" name="remember_me" value="yes" type="checkbox" id="form-check-default" @if (isset($_COOKIE['email']))
                                                    checked
                                                @endif>
                                ...
                                <div class="col-12">
                                    <div class="text-center">
                                        <p class="mb-0">Dont't have an account ? <a href="{{ route("auth.signup") }}" class="text-warning">Sign Up</a></p>
                                    </div>
                                </div>
